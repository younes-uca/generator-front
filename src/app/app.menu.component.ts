    ...
    ngOnInit() {
        this.model = [
            ...
            },
            {
                ...
                items: [
                    {label: 'Commande', icon: 'pi pi-fw pi-globe', routerLink: ['/view/commande']},
                    {label: 'Pojo Load', icon: 'pi pi-fw pi-globe', routerLink: ['/view/pojo/load']},
                    {label: 'Pojo Show', icon: 'pi pi-fw pi-globe', routerLink: ['/view/pojo/show']},
                    {label: 'Pojo Generate', icon: 'pi pi-fw pi-globe', routerLink: ['/view/pojo/generate']},
